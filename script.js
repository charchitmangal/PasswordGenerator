...
async function copyContent(){
    try{
        await navigator.clipboard.writeText(password.valueOf());
...
generateBtn.addEventListener('click', ()=> {
    ...
    //let'sstart the journey to find new password
    ...
    console.log("after cumpolsory addition");
    ...
    //suffle the password characters
